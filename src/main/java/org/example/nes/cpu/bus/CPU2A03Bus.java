...
public class CPU2A03Bus extends AbstractBus implements Bus {
    public CPU2A03Bus(BusConfiguration busConfiguration, PPU2C02 ppu, DMAController dmaController, InputController inputController) {
        super(new CPUBusConfiguration(ppu, busConfiguration, dmaController, inputController));
    }
}
